...
import static com.projet26.domain.ProductAsserts.*;
import static com.projet26.web.rest.TestUtil.createUpdateProxyForBean;
import static com.projet26.web.rest.TestUtil.sameNumber;
...
import com.projet26.IntegrationTest;
import com.projet26.domain.Product;
import com.projet26.repository.ProductRepository;
...
class ProductResourceIT {
    ...
    public static Product createEntity() {
        return new Product().name(DEFAULT_NAME).price(DEFAULT_PRICE).stock(DEFAULT_STOCK);
    }
    ...
    public static Product createUpdatedEntity() {
        return new Product().name(UPDATED_NAME).price(UPDATED_PRICE).stock(UPDATED_STOCK);
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).price(UPDATED_PRICE).stock(UPDATED_STOCK);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).price(UPDATED_PRICE).stock(UPDATED_STOCK);
